...
#TUTORIAL: https://mherman.org/blog/flask-for-node-developers/

#test with curl:
# curl --data "artist='Hudson Mohawke'&title='Cbat'&rating=5" http://localhost:5000/api/songs

#central object, instance of Flask class
app = Flask(__name__)
...
def collection():
    if request.method == 'GET':
        ...
        #json module for turning sql data to json
...
@app.route('/api/song/<song_id>', methods=['GET', 'POST', 'DELETE'])
